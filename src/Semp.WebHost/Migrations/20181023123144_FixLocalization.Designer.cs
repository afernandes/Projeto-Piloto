...
namespace Semp.WebHost.Migrations
{
    ...
    [Migration("20181023123144_FixLocalization")]
    partial class FixLocalization
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Semp.Infrastructure.Localization.Culture", b =>
                {
            ...
            modelBuilder.Entity("Semp.Infrastructure.Localization.Resource", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Semp.Infrastructure.Localization.Resource", b =>
                {
                    b.HasOne("Semp.Infrastructure.Localization.Culture", "Culture")
                        .WithMany("Resources")
